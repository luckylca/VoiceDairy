...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    dark: {
      ...
      onPrimaryContainer: '#9AF6AA',
      secondary: '#B6CCB7',
      secondaryContainer: '#384B3B',
      onSecondaryContainer: '#D2E8D2',
    },
  },
  {
    label: '日落橙',
    ...
    dark: {
      ...
      secondary: '#E1C1A4',
      secondaryContainer: '#59432D',
      onSecondaryContainer: '#FEDDBF',
    },
  },
  {
    label: '玫瑰粉',
